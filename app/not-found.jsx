...
export default function NotFound() {
  return (
    <main className="relative min-h-screen bg-white-custom overflow-hidden flex flex-col">
      ...
      {/* Orange glow — centered background accent */}
      <div
        className="pointer-events-none absolute"
        style={{
          width: 900,
          height: 900,
          background: 'rgba(249, 149, 90, 0.08)',
          filter: 'blur(150px)',
          borderRadius: '9999px',
          top: '50%',
          left: '50%',
      ...
      {/* Large faded dot mark — bottom-right decoration */}
      <div
        className="pointer-events-none select-none absolute"
        style={{ bottom: '-6%', right: '-3%', opacity: 0.045 }}
      >
        <svg width="560" height="924" viewBox="0 0 26.62 44" fill="none">
          <circle cx="13.28" cy="4.46"  r="4.46" fill="black" />
          <circle cx="13.28" cy="22"    r="4.46" fill="black" />
          <circle cx="13.29" cy="39.54" r="4.46" fill="black" />
          <circle cx="4.52"  cy="13.27" r="4.49" fill="black" />
          <circle cx="22.13" cy="13.27" r="4.49" fill="black" />
          <circle cx="4.49"  cy="30.78" r="4.49" fill="black" />
          <circle cx="22.07" cy="30.78" r="4.49" fill="black" />
        </svg>
      </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 pb-24">
        ...
        {/* Large 404 */}
        <span
          className="font-aeonik leading-none tracking-tight text-black-custom select-none"
          style={{ fontSize: 'clamp(96px, 20vw, 240px)' }}
        >
          404
        </span>

        {/* Divider */}
        <div className="w-14 h-px bg-black-custom mt-8 mb-8" />
