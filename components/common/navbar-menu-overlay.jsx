        ...
        >
            ...
            <div className="lg:hidden max-w-480 mx-auto page-x pb-16" style={fade(80)}>
                ...
                <div className="flex items-center gap-3 mt-10 font-tt text-[14px]">
                    ...
                    <span className="text-gray-language uppercase cursor-pointer hover:text-foreground transition-colors">English</span>
                    <span className="text-black-custom font-medium uppercase cursor-pointer">Ελληνικά</span>
                </div>
            </div>
