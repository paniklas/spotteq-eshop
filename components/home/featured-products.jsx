            ...
            <div className="max-w-480 mx-auto page-x pt-10 xl:pt-20">
                ...
                {!compact && (
                    <div className="md:flex md:items-start md:justify-between mb-6">
                        <h2 className="font-aeonik text-black-custom text-[28px] xl:text-[35px] leading-none mb-4 md:mb-0 shrink-0">
                            Featured Products
                        </h2>
                ...
                {/* Mobile — SHOP ALL below the header, above the carousel */}
                {!compact && (
                    <Link
                        href="/shop/shop-all"
                ...
                {/* Mobile carousel — one product at a time */}
                <div className="md:hidden">
                    <ProductCarousel products={products} />
                </div>

                {/* Tablet-only bottom button */}
                {!compact && (
