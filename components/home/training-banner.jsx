        ...
        >
            <div className="max-w-480 mx-auto page-x">
                <Link
                    ...
                    className="group relative block max-w-275"
                >
                    <div className="relative overflow-hidden rounded-[30px] aspect-787/518 md:aspect-auto md:h-100 xl:h-140">
                        <Image
                            src={TRAINING_IMG}
                        ...
                        <div className="absolute inset-0 p-4 md:p-8 flex flex-col justify-between">
                            ...
                            {/* Bottom block — static on mobile, shifts up on hover on desktop */}
                            <div className="flex flex-col gap-3 md:translate-y-[calc(1.6em+0.75rem)] md:group-hover:translate-y-0 transition-transform duration-500 ease-out">
                                ...
                                <p className="hidden md:block font-aeonik text-white-custom text-[14px] xl:text-[18px] max-w-175 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-150">
                            ...
                            {/* Arrow — visible on mobile, hover-animated on desktop */}
                            <svg width="55" height="15" viewBox="0 0 55 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute bottom-3 right-4 w-9 h-9 md:w-14 md:h-14 opacity-100 translate-x-0 md:opacity-0 md:-translate-x-14 md:group-hover:opacity-100 md:group-hover:translate-x-0 transition-all duration-500 ease-out delay-100">
                    ...
                    {/* Mobile only — description shown below the card in black */}
                    <p className="md:hidden mt-3 font-aeonik text-black-custom text-[13px] leading-[1.3]">
                        From wraps and shakers to everyday carry bags, these training accessories cover the small details that keep every session smoother, safer and more efficient.
                    </p>
                </Link>
            </div>
